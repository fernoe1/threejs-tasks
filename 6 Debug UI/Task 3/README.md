...
1. elevate on y position axis, min -3, max 3, step 0.1;

2\. scale on all 3 axes, min 1, max 3, step 0.1;

3\. visible checkbox;

4\. wireframe checkbox;

5\. color picker that shows actual color;

6\. spin function that spins on y axis 360 degrees.
